    <div class="container top">
      ...
      <div class="page-header">
        <h2>
          Add <?php echo "Image"; //ucfirst($this->uri->segment(2));?>
        </h2>
      </div>
      ...
      $input_text_attributes = array('name' => 'title', 'type' => 'text', 'class' => 'form-control', 'placeholder' => 'Title');
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <?php echo form_dropdown('galleryType', $gallery_type_attributes, 0, 'class=form-control'); ?>
            </div>
          </div>
        </div>
          ...
          <div class="text-center">
            <div class="fileinput fileinput-new" data-provides="fileinput">
              <div class="fileinput-new thumbnail" style="width: 400px; height: 200px;">
                ...
                <div>
                  <span class="btn btn-file btn-success"><span class="fileinput-new">Select image</span><span class="fileinput-exists">Change</span><input type="file" name="uploadImage"></span>
